...
<template>
  <Transition name="extra-details-card">
    <aside
      v-if="open"
      class="absolute bottom-3 right-3 top-14 z-40 flex w-[min(100%-1.5rem,28rem)] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl sm:w-[min(100%-1.5rem,32rem)]"
      role="complementary"
